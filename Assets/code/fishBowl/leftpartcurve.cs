...
public class leftpartcurve : MonoBehaviour {

    public LineRenderer left;
    public Transform point0, point2, point3, point4;

    private int pointcount = 1000;
    private Vector3[] positions1 = new Vector3[1001];
    public static List<Segment> leftcurve = new List<Segment>();

    // Use this for initialization
    void Start () {
        left.positionCount = 1001;
        DrawLeftCurveLine();
    ...
    private void DrawLeftCurveLine()
    {
